      ...
      <div class="row-fluid">
        <div class="span12">
          <div class="widget-box">
            ...
            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="<?php echo e(url('/admin/edit-product/'.$productDetails->id)); ?>"
             name="edit_product" id="edit_product" novalidate="novalidate"> <?php echo e(csrf_field()); ?>
             ...
             <div class="control-group">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                      <textarea name="description" id="description"><?php echo e($productDetails->description); ?></textarea>
                    </div>
                  </div>
                  <div class="control-group">
                      <label class="control-label">Material & Care</label>
                      <div class="controls">
                        <textarea name="care" id="care"><?php echo e($productDetails->care); ?></textarea>
                      </div>
                    </div>
                  <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <img style="width:50px;" src="<?php echo e(asset('/images/backend_img/products/small/'.$productDetails->image)); ?>"> 
                        | <a href="<?php echo e(url('/admin/delete-product-image/'.$productDetails->id)); ?>">Delete</a>
                        <?php endif; ?>    
                    </div>
                      </div>
